...
import (
	...
	"github.com/ryo-watanabe/k8s-volume-snap/pkg/client/clientset/versioned/scheme"
...
// VolumesnapshotV1alpha1Client is used to interact with features provided by the volumesnapshot.rywt.io group.
type VolumesnapshotV1alpha1Client struct {
	restClient rest.Interface
}

func (c *VolumesnapshotV1alpha1Client) ObjectstoreConfigs(namespace string) ObjectstoreConfigInterface {
	return newObjectstoreConfigs(c, namespace)
}

func (c *VolumesnapshotV1alpha1Client) VolumeRestores(namespace string) VolumeRestoreInterface {
