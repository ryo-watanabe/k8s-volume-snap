...
import (
	v1alpha1 "github.com/ryo-watanabe/k8s-volume-snap/pkg/client/clientset/versioned/typed/volumesnapshot/v1alpha1"
...
func (c *FakeVolumesnapshotV1alpha1) ObjectstoreConfigs(namespace string) v1alpha1.ObjectstoreConfigInterface {
	return &FakeObjectstoreConfigs{c, namespace}
}

func (c *FakeVolumesnapshotV1alpha1) VolumeRestores(namespace string) v1alpha1.VolumeRestoreInterface {
