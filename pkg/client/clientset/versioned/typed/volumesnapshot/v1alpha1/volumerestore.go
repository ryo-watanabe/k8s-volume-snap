...
type VolumeRestoreInterface interface {
	...
	UpdateStatus(ctx context.Context, volumeRestore *v1alpha1.VolumeRestore, opts v1.UpdateOptions) (*v1alpha1.VolumeRestore, error)
...
func (c *volumeRestores) UpdateStatus(ctx context.Context, volumeRestore *v1alpha1.VolumeRestore, opts v1.UpdateOptions) (result *v1alpha1.VolumeRestore, err error) {
	result = &v1alpha1.VolumeRestore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("volumerestores").
