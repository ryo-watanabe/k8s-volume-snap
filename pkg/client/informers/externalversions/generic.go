...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=volumesnapshot.rywt.io, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("objectstoreconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Volumesnapshot().V1alpha1().ObjectstoreConfigs().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("volumerestores"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Volumesnapshot().V1alpha1().VolumeRestores().Informer()}, nil
